...
void WidgetOpenGL::initializeGL()
{
    ...
    QString message("Résultat OK\n\n");
    message += QString("Carte graphique : ") + (char*)glGetString(GL_RENDERER) + "\n";
    message += QString("Version OpenGL : ") + (char*)glGetString(GL_VERSION) + "\n";
    message += QString("Version GLSL : ") + (char*)glGetString(GL_SHADING_LANGUAGE_VERSION) + "\n";

    QMessageBox msg;
    msg.setText("Bilan test OpenGL");
    msg.setInformativeText(message);
    msg.setDetailedText("Réalité Virtuelle 2022-2023\n\n leo.donati@univ-cotedazur.fr");
    msg.exec();
}
